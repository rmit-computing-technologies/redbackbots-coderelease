...
void FieldPainter::drawField() {
   ...
   // penalty boxes
   drawRect(-FIELD_LENGTH/2, -PENALTY_BOX_WIDTH/2, PENALTY_BOX_LENGTH, PENALTY_BOX_WIDTH);
   drawRect(FIELD_LENGTH/2 - PENALTY_BOX_LENGTH, -PENALTY_BOX_WIDTH/2, PENALTY_BOX_LENGTH, PENALTY_BOX_WIDTH);
   drawEllipse(QPointF(0, 0), CENTER_CIRCLE_DIAMETER/2, CENTER_CIRCLE_DIAMETER/2);
   ...
   drawEllipse(QPointF(-goal_x, -GOAL_WIDTH/2), GOAL_POST_DIAMETER/2, GOAL_POST_DIAMETER/2);
   drawEllipse(QPointF(-goal_x,  GOAL_WIDTH/2), GOAL_POST_DIAMETER/2, GOAL_POST_DIAMETER/2);
   drawEllipse(QPointF( goal_x, -GOAL_WIDTH/2), GOAL_POST_DIAMETER/2, GOAL_POST_DIAMETER/2);
   drawEllipse(QPointF( goal_x,  GOAL_WIDTH/2), GOAL_POST_DIAMETER/2, GOAL_POST_DIAMETER/2);

...
class Shooter(Role):
    ...
    def default_position(self, robot_pos, ball_pos):
        ...
        position = ball_pos.plus(
            makeVector2DFromDistHeading(
                dist_to_ball, ball_to_opponent_goal_heading))
...
class PositioningAgainstDribbleTeam(Positioning):
    ...
    def __init__(self):
        ...
        # anticipating
        self.roles = [
            ["right_supporter", POSITIONING_AGAINST_DRIBBLE_TEAM_RIGHT_SUPPORTER, # noqa
             Supporter(self, 2)],
            ["shooter", POSITIONING_AGAINST_DRIBBLE_TEAM_SHOOTER,
             Shooter(self)],
            ["left_supporter", POSITIONING_AGAINST_DRIBBLE_TEAM_LEFT_SUPPORTER,
             Supporter(self, 1)],
            ["sweeper", POSITIONING_AGAINST_DRIBBLE_TEAM_SWEEPER,
             Sweeper(self)],
        ]

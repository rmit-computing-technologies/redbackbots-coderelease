...
class RolePriority:
    ...
    competition = [("Upfielder", "Center"), ("Midfielder", "Center"), ("Defender", "Left"), ("Defender", "Right")]
    ready_state = [("Upfielder", "Center"), ("Midfielder", "Center"), ("Defender", "Left"), ("Defender", "Right")]

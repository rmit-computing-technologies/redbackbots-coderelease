...
Kinematics::Kinematics() {
   ...
   chest.push_back(vec4<float>(-44, -39.5, Limbs::NeckOffsetZ -32 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(-34, -54, Limbs::NeckOffsetZ - 32 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(-38, -70, Limbs::NeckOffsetZ - 25 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(-33, -90, Limbs::NeckOffsetZ + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(-22, -95, Limbs::NeckOffsetZ + 9 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(-8, -90, Limbs::NeckOffsetZ + 15.5 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(10, -90, Limbs::NeckOffsetZ + 17.5 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(25, -90, Limbs::NeckOffsetZ + 8.5 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(34, -81, Limbs::NeckOffsetZ -2.2 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(43, -83, Limbs::NeckOffsetZ - 21 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(31, -61, Limbs::NeckOffsetZ -35 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(50, -39, Limbs::NeckOffsetZ - 48 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(55, -20, Limbs::NeckOffsetZ - 48 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(55, 0, Limbs::NeckOffsetZ - 45 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(55, 20, Limbs::NeckOffsetZ - 48 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(50, 39, Limbs::NeckOffsetZ - 48 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(31, 61, Limbs::NeckOffsetZ -35 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   chest.push_back(vec4<float>(43, 83, Limbs::NeckOffsetZ - 21 + Limbs::HipOffsetZ - Limbs::HipOffsetY, 1));
   ...
   for (int i=0; i<NUM_RECORDED_FRAMES_OF_SIDE_LEAN; i++){
      previous_side_lean[i] = 0;
   }
}

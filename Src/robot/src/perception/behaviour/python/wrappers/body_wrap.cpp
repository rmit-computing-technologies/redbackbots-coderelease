...
enum_<Sensors::SensorCodesEnum>("Sensors")
   ...
   .value("Head_Touch_Front"              , Sensors::Head_Touch_Front            )
   .value("Head_Touch_Middle"             , Sensors::Head_Touch_Middle           )
   .value("Head_Touch_Rear"               , Sensors::Head_Touch_Rear             )
   ...
   .value("SonarLeft"                     , Sensors::SonarLeft                   )
   .value("SonarRight"                    , Sensors::SonarRight                  )

   ...
   scope().attr("PENALTY_BOX_WIDTH"         ) = PENALTY_BOX_WIDTH;
   scope().attr("PENALTY_BOX_LENGTH"        ) = PENALTY_BOX_LENGTH;
   ...
   scope().attr("GOAL_FREE_KICK_ABS_X"      ) = GOAL_FREE_KICK_ABS_X;
   scope().attr("GOAL_FREE_KICK_ABS_Y"      ) = GOAL_FREE_KICK_ABS_Y;

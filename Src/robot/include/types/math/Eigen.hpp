 ...
 * @file Eigen.h
 *
 * Common data types based on Eigen types
 *
 * @author B-Human
 * @author RedbackBots
 */
...
/*
 * Extend the Eigen classes (see: https://eigen.tuxfamily.org/dox/UserManual_CustomizingEigen.html)
 * These #defines MUST appear before any include of the Eigen library.
 * Therefore any code using Eigen should include THIS header file and NOT directly include Eigen
 *     as this may cause header file ordering issues for subsequent includes.
 */ 
#define EIGEN_MATRIXBASE_PLUGIN "types/math/EigenMatrixBaseExtensions.hpp"
#define EIGEN_ARRAY_PLUGIN "types/math/EigenArrayExtensions.hpp"

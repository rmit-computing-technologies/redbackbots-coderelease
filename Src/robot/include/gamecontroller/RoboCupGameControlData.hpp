...
// tell the compiler not to optimise these structs and align them in any way
// makes it easier to convert to and from byte arrays with a reinterpret cast
#pragma pack(push, 1)
struct RobotInfo
{
...
struct RoboCupGameControlData
{
  ...
  // these are all bytes (8 bit unsigned chars)
